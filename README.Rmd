...
The `bis620.2022` package provides functionality for plotting and transforming synthesized UKBiobank Accelerometry data.
...
This package includes two main functions for interacting with the data:
- `R/plot.R/accel_plot()` plots acceleration in the 3 different channels (X, Y, Z) as a time series.
- `R/spectral.R/spectral_signature()` calculates the spectral signature for each channel by applying a Fourier transform.
